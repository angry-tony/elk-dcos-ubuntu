...
ELA_NETWORK_HOST=192.0.220.104  # slave-node-ip

KIBANA_SERVICE_NAME=kibana

cp elasticdeploy.json elasticdeploy.json.BAK
...
cp kibanadeploy.json kibanadeploy.json.BAK
...
cp filebeatdeploy.sh filebeatdeploy.sh.BAK
